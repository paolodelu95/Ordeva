...
/**
 * Card di collegamento/sincronizzazione per i canali marketplace (eBay,
 * Shopify, Amazon) — usato dentro Impostazioni → Sincronizzazione, accanto
 * alla card Google. Le statistiche vendite per canale vivono invece nella
 * pagina Marketplace (sotto Vendite): sono un report, non una configurazione.
 */
@Component({
  selector: 'app-marketplace-canali',
  standalone: true,
...
export class MarketplaceCanaliComponent implements OnInit {
